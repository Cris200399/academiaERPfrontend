  ...
  <div class="admin-users-container">
    ...
    >
      <div class="dialog-content">
        ...
        <div class="form-group">
          <label>Rol</label>
          <InputText value="Admin" disabled class="disabled-input"/>
        </div>
      </div>
...
import {createUserService, deleteUserService, getAdminsService, updateUserService} from "@/services/userService";
...
const dialogHeader = computed(() =>
    isEditing.value ? 'Editar Admin' : 'Nuevo Admin'
);
...
const loadUsers = async () => {
  ...
  try {
    ...
    const userResponse = await getAdminsService();
...
const saveUser = async () => {
  ...
  try {
    if (isEditing.value) {
      ...
      const newUser = new User('', editedUser.name, editedUser.email, editedUser.password, 'admin');
